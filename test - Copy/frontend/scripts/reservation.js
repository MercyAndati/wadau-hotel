...
function processReservation(paymentMethod) {
  ...
  const reservation = {
    ...
    status:  paymentMethod === "Pay Now" ? "processing" : "awaiting", // Default status
    amount: cartTotal, // Add the cart total to the reservation
    items: cart, // Include the cart items if needed
  ...
  if (paymentMethod === "Pay Now") {
    ...
    // For pay on arrival, save directly to reservations
